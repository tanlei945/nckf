  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        ...
        <a-col :md="6" :sm="8">
            <a-form-item label="是否显示（0：不显示  1：显示）">
              <a-input placeholder="请输入是否显示（0：不显示  1：显示）" v-model="queryParam.showFlag"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="排序号">
              <a-input placeholder="请输入排序号" v-model="queryParam.sortId"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
