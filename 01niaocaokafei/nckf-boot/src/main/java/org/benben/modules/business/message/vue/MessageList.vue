    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="删除状态（0-已删除 1-未删除）">
              <a-input placeholder="请输入删除状态（0-已删除 1-未删除）" v-model="queryParam.delFlag"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="图片">
              <a-input placeholder="请输入图片" v-model="queryParam.imgUrl"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
