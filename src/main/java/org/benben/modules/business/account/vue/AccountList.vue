    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="0:非会员 1：会员">
              <a-input placeholder="请输入0:非会员 1：会员" v-model="queryParam.vipFlag"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
            <a-form-item label="账号 支付账号或微信账号或银行卡号">
              <a-input placeholder="请输入账号 支付账号或微信账号或银行卡号" v-model="queryParam.accountNo"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
