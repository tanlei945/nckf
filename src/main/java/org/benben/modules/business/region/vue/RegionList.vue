    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="省份名称">
              <a-input placeholder="请输入省份名称" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
        ...
        <a-col :md="6" :sm="8">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="行政层级">
              <a-input placeholder="请输入行政层级" v-model="queryParam.levelType"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="行政编码">
              <a-input placeholder="请输入行政编码" v-model="queryParam.cityCode"></a-input>
            </a-form-item>
          </a-col>
        </template>
          <a-col :md="6" :sm="8" >
