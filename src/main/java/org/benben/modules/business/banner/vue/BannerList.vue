  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        ...
        <a-col :md="6" :sm="8">
            <a-form-item label="是否删除：0-已删除  1-未删除">
              <a-input placeholder="请输入是否删除：0-已删除  1-未删除" v-model="queryParam.delFlag"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="是否有用：0-不启用 1-启用">
              <a-input placeholder="请输入是否有用：0-不启用 1-启用" v-model="queryParam.useFlag"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
