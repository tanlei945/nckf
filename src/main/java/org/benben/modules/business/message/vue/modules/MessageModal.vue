    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="删除状态（0-已删除 1-未删除）">
          <a-input placeholder="请输入删除状态（0-已删除 1-未删除）" v-decorator="['delFlag', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="1:系统消息 2：订单消息">
          <a-input placeholder="请输入1:系统消息 2：订单消息" v-decorator="['messageType', {}]" />
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'titile','msgContent','sender','delFlag','imgUrl','messageType'))
		  //时间格式化
        });
